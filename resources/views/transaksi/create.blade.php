...
<div class="card card-indigo card-outline">
  <div class="card-header">
    <div class="row">
      ...
      <div class="col">
        <form class="card card-primary card-outline p-2" method="POST" action="{{ route('transaksi.add',['member'=>$member->id]) }}">
        ...
        @forelse ($items as $item)
            <tr>
              ...
              <td>
                ...
                @if ($item->attributes->diskon)
                  ({{ $item->attributes->diskon }}%)
                @endif
              </td>
              <td>
              ...
              <td>
                <a href="{{ route('transaksi.updateChart',[
                  'member'=>$member->id,
                  'paket'=>$item->id,
                  'type'=>'plus'
                ...
                <a href="{{ route('transaksi.delete',['member'=>$member->id,'paket'=>$item->id]) }}" class="btn p-0 text-danger">
  ...
  <form class="card-body border-top" method="POST" action="{{ route('transaksi.store',['member'=>$member->id]) }}">
