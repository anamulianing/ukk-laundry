<form class="card-body border-top" method="POST" action="{{ route('transaksi.update',['transaksi'=>$transaksi->id]) }}">
  ...
  <div class="row">
    ...
    <div class="col">
      ...
      <div class="form-group row">
        ...
        <div class="col">
          <button type="submit" class="btn btn-primary btn-block"><i class="fas fa-database"></i> Update
            Pembayaran</button>
        </div>
      </div>
