...
class TransaksiController extends Controller
{
    ...
    public function updateChart(Request $request, Member $member, Paket $paket)
    {
        $type = $request->type;
    ...
    public function store(Request $request, Member $member, Paket $paket)
    {
        $request->validate([
        ...
        LogActivity::add('membuat Transaksi');
    ...
    public function update(Request $request, Transaksi $transaksi)
    {
        ...
        LogActivity::add('mengubah Status Bayar menjadi Dibayar');
